...
public class MouseAxisScreen extends GenericInputScreen
{
    ...
    protected void Populate()
    {
        ...
        isYBox = Checkbox.builder(CreateTweakedControllers.translateDirect("gui_config_isyaxis"), font)
            .pos(width / 2 - 60, height/2 - 95)
            .selected(source.isYAxis)
            .build();
        addRenderableWidget(isYBox);
        useVelBox = Checkbox.builder(CreateTweakedControllers.translateDirect("gui_config_usevelocity"), font)
